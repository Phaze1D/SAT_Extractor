...
public class Emisor {
    ...
    public static boolean findByRFC(String value){
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT rfc FROM Emisors WHERE rfc = ?");
    ...
    public static int getDatabaseID(String rfc){
        ...
        try {
            con = DBConnector.getInstance().getConnection();
            ps = con.prepareStatement("SELECT id FROM Emisors WHERE rfc = ?");
            ps.setString(1, rfc);
            rs = ps.executeQuery();
            if(rs.next()) {
                return rs.getInt("id");
    ...
    public void save(){
        ...
        try {
            con = DBConnector.getInstance().getConnection();
            ps = con.prepareStatement("INSERT INTO Emisors (nombre, rfc)" + "VALUES (?, ?)");
